...
class OeMedicalPatient(osv.Model):
	...
	_columns={
		...
		'age': fields.function(_compute_age, string= "Age",arg=None, fnct_inv=None, fnct_inv_arg=None, type="char",fnct_search=None, obj=None, method=True, store=False, multi=False,),
